...
func (app *application) snippetCreate(w http.ResponseWriter, r *http.Request) {
	...
	// instantiate a new snippetCreateForm struct containing the form data
	// provide default value for expires
...
// the struct tag `form:"-"` tells the form package to ignore the field
